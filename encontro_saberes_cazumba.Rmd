...
author: "Arlindo Gomes Filho- ICMBio/CENAP"
date: "`r Sys.Date()`"
...
Por se tratar de um relatório simplificado, este documento não inclui detalhes sobre métodos de coleta ou análise dos dados. Ele também não inclui detalhes sobre o esforço de amostragem, pois essa informação já consta do relatório produzido pelo CEMAVE. Portanto, o relatório apenas apresenta as variações anuais nas populações de espécies ou grupos de aves registrados na área.


## Número total de encontros

A tabela 1 apresenta o número total de encontros e de indivíduos avistados por espécie/grupo.
